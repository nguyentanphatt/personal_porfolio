    ...
    <div className="w-full overflow-hidden py-2">
      ...
      >
        {item.map((tech, index) => (
          ...
          className="flex items-center justify-center gap-1 md:gap-2.5 lg:gap-4 p-1.5 md:p-3 bg-gradient-to-r from-light-blue to-sky-blue rounded-full md:rounded-2xl hover:shadow-[0_0_10px_5px_rgba(82,157,255,1)]"
        >
          <Image
            src={tech.image}
            alt={tech.name}
